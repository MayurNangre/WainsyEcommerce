...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::get('/pickup_request','OrderController@pickup_form_details')->name('pickup_dashboard');
    Route::get('/pickup_form/{id}','OrderController@show_form_pickup')->name('show_pickup_form');
    Route::post('/pickup_form/submit','OrderController@submit_pickup_form')->name('submit_pickup');
});
...
Route::get('/payment/canceled','CheckoutController@cancel')->name('payment.cancel');
