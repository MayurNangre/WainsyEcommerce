...
@section('panel_content')
    ...
    <div class="row gutters-10">
        <div class="col-md-4">
            <div style="border-radius: 20px" class="bg-grad-1 text-white mb-4 overflow-hidden">
                <div class="px-3 pt-3">
                    @php
        ...
        <div class="col-md-4">
            <div style="border-radius: 20px" class="bg-grad-2 text-white  mb-4 overflow-hidden">
                <div class="px-3 pt-3">
                    @php
        ...
        <div class="col-md-4">
            <div style="border-radius: 20px" class="bg-grad-3 text-white  mb-4 overflow-hidden">
                <div class="px-3 pt-3">
                    @php
                        $orders = \App\Models\Order::where('user_id', Auth::user()->id)->get();
                        $total = 0;
