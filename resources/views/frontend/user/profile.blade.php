    ...
    <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data">
        ...
        @if(Auth::user()->seller)
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <label class="col-md-3 col-form-label">{{ translate('IFSC Code') }}</label>
                    <div class="col-md-9">
                        <input type="number" lang="en" class="form-control mb-3" placeholder="{{ translate('IFSC Code')}}" value="{{ Auth::user()->seller->ifsc_code }}" name="ifsc_code">
                    </div>
                </div>
                <div class="row">
                    <label class="col-md-3 col-form-label">{{ translate('UPI ID') }}</label>
                    <div class="col-md-9">
                        <input type="number" lang="en" class="form-control mb-3" placeholder="{{ translate('UPI ID')}}" value="{{ Auth::user()->seller->upi_id }}" name="upi_id">
                    </div>
                </div>
            </div>
            </div>
