<div class="aiz-card-box border border-light rounded hov-shadow-md mt-1 mb-2 has-transition bg-white">
    ...
    <div class="position-relative">
        <a href="{{ route('product', $product->slug) }}" class="d-block">
            <img class="img-fit lazyload mx-auto h-140px h-md-210px" src="{{ static_asset('assets/img/placeholder.jpg') }}"
        ...
        <div class="absolute-top-right aiz-p-hov-icon">
            ...
            <a href="javascript:void(0)" onclick="showAddToCartModal({{ $product->id }})" data-toggle="tooltip"
                ...
                <i class="las la-shopping-cart fa-shake"></i>
            </a>
            <a href="javascript:void(0)" onclick="addToCompare({{ $product->id }})" data-toggle="tooltip"
                ...
                <i class="las la-sync fa-spin"></i>
                {{-- <i class="fa-regular fa-code-compare fa-spin" style="color: #cb8e3e;"></i> --}}
            </a>
        </div>
    </div>
    <div class="p-md-3 p-2 text-left">
        ...
        <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
            <a href="{{ route('product', $product->slug) }}" class="d-block text-reset"
                style="font-family: 'Montserrat', sans-serif;">{{ $product->getTranslation('name') }}</a>
        </h3>
