                            ...
                            @foreach ($featured_categories as $key => $category)
                                <li class="minw-0 col-4 col-md mt-3">
                                    <a href="{{ route('products.category', $category->slug) }}"
                                        class="d-block  bg-white p-2 text-reset shadow-sm  myrounded-10">
                ...
                <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                    ...
                    <div class="d-flex flex-wrap mb-3 align-items-baseline border-bottom">
                        ...
                        <a href="{{ route('flash-deal-details', $flash_deal->slug) }}"
                            class="ml-auto mr-0 btn btn-primary btn-sm shadow-md w-100 w-md-auto top20btn">{{ translate('View More') }}</a>
                    </div>
                    ...
                    <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                        <div class="d-flex mb-3 align-items-baseline border-bottom">
                            ...
                            <a href="{{ route('customer.products') }}"
                                class="ml-auto mr-0 btn btn-primary btn-sm shadow-md top20btn">{{ translate('View More') }}</a>
                        </div>
                        <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5"
                            data-lg-items="4" data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true'>
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex mb-3 align-items-baseline border-bottom">
                                ...
                                <a href="{{ route('categories.all') }}"
                                    class="ml-auto mr-0 btn btn-primary btn-sm shadow-md top20btn">{{ translate('View All Categories') }}</a>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex mb-3 align-items-baseline border-bottom">
                                ...
                                <a href="{{ route('brands.all') }}"
                                    class="ml-auto mr-0 btn btn-primary btn-sm shadow-md top20btn">{{ translate('View All Brands') }}</a>
                            </div>
                            <div class="row gutters-5">
