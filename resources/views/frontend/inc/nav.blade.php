...
@endif
<!-- Top Bar -->
<div class="topnavbarmain top-navbar border-bottom border-soft-secondary z-1035">
    <div class="container">
        <div class="row">
                ...
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    ...
                    @auth
                        ...
                        @else
                            ...
                            <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                                <a href="{{ route('dashboard') }}" style="font-size:1rem"
                                    class="text-reset d-inline-block font-weight-bold  py-2">{{ translate('My Panel') }}</a>
                            </li>
                        @endif
                        <li class="list-inline-item">
                            <a href="{{ route('logout') }}" style="font-size:1rem"
                                class="text-reset d-inline-block font-weight-bold  py-2">{{ translate('Logout') }}</a>
                        </li>
                    @else
                        <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                            <a href="{{ route('user.login') }}" style="font-size:1rem"
                                class="text-reset d-inline-block  font-weight-bold py-2 ">{{ translate('Login') }}</a>
                        </li>
                        <li class="list-inline-item">
                            <a href="{{ route('user.registration') }}" style="font-size:1rem"
                                class="text-reset d-inline-block font-weight-bold py-2 ">{{ translate('Registration') }}
                            </a>
                        </li>
                    @endauth
                </ul>
...
<header class="@if (get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white border-bottom shadow-sm">
    <div class="mainheadertop position-relative logo-bar-area z-1">
        <div class="container">
                                ...
                                <div class="input-group myback ">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-append">
                                            <button
                                                class="btn btn-outline-secondary bg-white border-bottom-0 border rounded-pill ms-n5 mybtn"
                                                type="submit">
                                                <i class="fa fa-search mybtn"></i>
                                            </button>
                                        </span>
                                    </div>
