                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <select class="form-control aiz-selectpicker" name="discount_type">
                                    <option value="amount" id="flat_amount" name="flat_amount">{{translate('Flat')}}</option>
                                    <option value="percent" id="percent_amount" name="percent_amount">{{translate('Percent')}}</option>
                                </select>
                            </div>
                            {{-- <div class="col-md-3">
                                <select class="form-control aiz-selectpicker" name="discount_type">
                                    <option value="amount" id="flat_amount" name="flat_amount" {{ $discount_type === 'amount' ? 'selected' : '' }}>{{translate('Flat')}}</option>
                                    <option value="percent" id="percent_amount" name="percent_amount" {{ $discount_type === 'percent' ? 'selected' : '' }}>{{translate('Percent')}}</option>
                                </select>
                            </div> --}}
                        </div>
